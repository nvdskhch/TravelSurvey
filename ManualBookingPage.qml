...
Page {
    ...
    function updateCost() {
        costText.text = departure && destinationInput.currentText ? (surveyModel.getTripCost(departure, destinationInput.currentText) > 0 ? "Стоимость поездки: " + surveyModel.getTripCost(departure, destinationInput.currentText) + " руб." : "Маршрут недоступен") : "Выберите места отправления и назначения";
    }
    ...
    Text {
        ...
        text: "Запланировать путешествие"
        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    surveyModel.bookTrip(departure,
                                         destination,
